						...
						<div class="container prodlist">
							<c:if test="${not empty loginForm.pr}">
											...
											<td>
												<div class="panel"
													...
													<div class="row">
														<div class="col-md-1"></div>
														<div class="col-md-11">
															<span style="color: #aaa">Description: ${loginForm.pr.etat }</span>
														</div>
													</div>
												</div>
											</td>
								...
								<c:if test="loginForm.timeout">
									<div class="row">
										<div class="panel">
											<h2>Time is out for this product. It no more appears on users feed.</h2>
										</div>
									</div>
								</c:if>
										...
										<c:if test="${empty loginForm.lb }">
											<div class="col-md-12" style="border: 1px solid #a1a1a1;">
												<h2 style="color: #aaa; text-align: center;">
													No bids have been made for this product 
												</h2>
											</div>
										</c:if>
									</div>
