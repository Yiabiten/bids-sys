			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a class="active" href="my_products"><i
								class="fa fa-table fa-fw"></i> My Products</a></li>
								...
								<c:if test="${ empty loginForm.lp }">
									...
									<div class="col-md-6" style="border: 1px solid #a1a1a1;">
										<h2 style="color: #aaa; text-align: center;">
											You did not post a product yet. <br />Wanna add one now ?<br />
											If 'yes', go to 'add Product' in the left menu.
										</h2>
									</div>
								</c:if>
																	...
																	<div class="col-md-3">
																		...
																		<form action="showProduct">
																			<button type="submit" name="id_prod"
																				value="${ prod.idProduit }" class="btn btn-default ">Show</button>
																		</form>
																	</div>
																</div>
																<div class="row">
