	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<ul class="nav navbar-top-links navbar-right">
				<li><a href="#">${loginForm.user.firstName} ${ loginForm.user.lastName }</a></li>
				<!-- /.dropdown -->
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="#"><i class="fa fa-table fa-fw"></i>
								My Products</a></li>
						<li><a  class="active" href="#"><i class="fa fa-table fa-fw"></i>
								Won Products</a></li>
						...
						<div class="container prodlist" >
                            <ul style="display:block" >
                                ...
                                <div class="row">
                                  <table>
                                    <tr>  
                                      <td><img src="img/1.jpg"  height=150  width=150 alt=""></td>
                                      <td><div class="panel" style="margin:0px; height:150px; width:400px; "><h3>Product #1</h3> </div></td>
                                    </tr>
                                  </table>
                                </div>
                                </li>
