				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="container prodlist">
							<f:form modelAttribute="loginForm" method="post" action="block">
										...
										<c:forEach items="${loginForm.lu}" var="uu">
											<div class="panel">
												<div class="row">
													...
													<div class="col-md-2">
														<c:if test="${uu.bloqued}">
															<span class="glyphicon glyphicon-remove"></span>
														</c:if>
														<c:if test="${not uu.bloqued}">
								...
								<div class="row">
									<div class="col-md-3"></div>
									<div class="col-md-4">
										<button class="btn btn-info btn-block">Block/Unblock</button>
									</div>
								</div>
							</f:form>
							<div class="row">
